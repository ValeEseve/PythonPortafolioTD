from modulos.iniciar_juego import mostrar_tutorial, validar_opcion
from modulos.combate import pj_ataca
from modulos.colores import RED, BOLD, RESET
from modulos.data import pj, pjs, enemigos, mazmorra, marco

opcion = 0

print(marco)
tutorial= input("¿Deseas leer el tutorial? Escribe S para mostrarlo: ").lower().strip()
if tutorial == "s":
    mostrar_tutorial()

print(f"\n\n{"."*15}{RED}Ven... avanza hacia la mazmorra{RESET}{"."*15}\n\n{"*"*60}\n{" "*20}¿Quién eres?\n{"*"*60}\n¿Eres acaso\n{" "*15}1. {pjs[0]["nombre"]}?\nO quizás...\n{" "*15}2. {pjs[1]["nombre"]}?\n¿De verdad eres...\n{" "*15}3. {pjs[2]["nombre"]}?")
